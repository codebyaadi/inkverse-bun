...
const Navbar = () => {
  ...
  return (
    <nav
      className={`sticky top-0 left-0 z-10  ${scrolling ? "bg-background" : "bg-transparent"
        }`}
    >
      <div
        id="nav-container"
        className="flex justify-between items-center m-auto max-w-7xl md:px-8 md:py-4 px-5 py-2.5"
      >
        <div>
